...
# Combining featureCounts .txt files downloaded from hotpurps repo commit (featureCounts_gene_id_pairs) on Jan 22, 2023
...
# create a new DGE list with counts from matrix just created
